class BudgetCategoriesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to budget_categories_path, status: :see_other, notice: "Budget category was successfully destroyed." }
  ...
  private
    ...
    def set_budget_category
      @budget_category = BudgetCategory.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def budget_category_params
      params.expect(budget_category: [ :name, :budgeted_amount, :trip_id ])
    end
end
